...
//    if (AdMob && current_utl.indexOf("index") == -1) {
//        var admobid = {};
//        admobid = {
//            banner: 'ca-app-pub-4125381083640557/3694596426', // or DFP format "/6253334/dfp_example_ad"
//            interstitial: 'ca-app-pub-4125381083640557/9741130021'
//        };
//        AdMob.createBanner({
//            adId: admobid.banner,
...
//        var big_ad_time = localStorage.getItem("big_ad_time");
//        if (big_ad_time) {
//            big_ad_time = parseInt(big_ad_time);
//        }
//        if (current_utl.indexOf("startup") == -1) {
//            if (!big_ad_time || new Date().getTime() > big_ad_time) {
//                AdMob.prepareInterstitial({
//                    adId: admobid.interstitial
//                    , autoShow: true
//                            //    , isTesting: true
//                });
//                localStorage.setItem("big_ad_time", new Date(new Date().getTime() + 5 * 60000).getTime());
//            }
//        }
//    }
}, false);
...
function initPurchase() {
    ...
    var $purchase_sel_item = $("#purchase_sel_item");
    var $party_list_main = $("#party_list_main");
    $("[name='billdate']", $purchase_home).glDatePicker({
        dateFormat: "yyyy-MM-dd"
    }).val(new Date().format("yyyy-MM-dd"));
...
function initItem() {
    ...
    $item_home.on("click", ".reportBox", function() {
        ...
        $("[name=iid]", $update_item).val(data_map.id);
...
function initPurchaseReport() {
    ...
    var $purchase_details = $("#purchase_details");
