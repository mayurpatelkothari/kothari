...
/*
 * jQuery EasIng v1.1.2 - http://code.google.com/p/kaytwo/source/browse/trunk/js/jquery.easing.js?r=746
 */
...
(function($){
  $.fn.CenterIt = function(options)
  {
    ...
    function CenterItem()
    {
      ...
      {
         var pos=(settings.position)?settings.position:"absolute";
        //IE Quirks Mode HACK as IE in Quirks Mode does not support fixed positioning
        control.css("position", pos);
      }
      else
      {
...
//      control.animate({
//          "top":(((windowHeight - (controlHeight + verticalMargin + verticalPadding)) / 2) + "px"),
//          "left":(((windowWidth - (controlWidth + horizontalMargin + horizontalPadding)) / 2) + "px")
//      });
      var top=((windowHeight - (controlHeight + verticalMargin + verticalPadding)) / 2);
      top=(top<0)?15:top;
      
      top += $(window).scrollTop();

      var left=((windowWidth - (controlWidth + horizontalMargin + horizontalPadding)) / 2);
