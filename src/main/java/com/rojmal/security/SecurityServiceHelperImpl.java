...
public class SecurityServiceHelperImpl implements SecurityServiceHelper {
  ...
  public void loginAsSystem() {
    ...
    try {
      ...
      Regisation registration = securityRegisteredUserManager.get(systemUserEmail);
  ...
  public void loginAsUser(String email) {
    ...
    SecurityContextHolder.getContext()
        .setAuthentication(new UsernamePasswordAuthenticationToken(user, user.getPassword(), user.getAuthorities()));
  }
  ...
  public void loginAsRole(String role) {
    ...
    SecurityContextHolder.getContext()
        .setAuthentication(new UsernamePasswordAuthenticationToken(user, user.getPassword(), authorities));
  }
